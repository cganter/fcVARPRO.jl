...
rw_in = lines!(ax, ϕs_HR, log10.(res_in_HR.χ2[:RW][:, 1]), color=:red)
fc_in = lines!(ax, ϕs_HR, log10.(res_in_HR.χ2[:FC][:, 1]), color=:blue)
...
rw_op = lines!(ax, ϕs_HR, log10.(res_op_HR.χ2[:RW][:, 1]), color=:red)
fc_op = lines!(ax, ϕs_HR, log10.(res_op_HR.χ2[:FC][:, 1]), color=:blue)
